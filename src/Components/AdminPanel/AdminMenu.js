  ...
  return (
    <div>
       <ul className='max-md:text-sm'>
              ...
              <li className='md:py-4 py-2 hover:bg-gray-200 sm:pl-10 pl-5 cursor-pointer'><i class="fa-solid fa-id-card text-cyan-950 mr-5"></i><Link to='/registration'>Registration</Link></li>
              ...
              <li className='md:py-4 py-2 hover:bg-gray-200 sm:pl-10 pl-5 cursor-pointer'><i class="fa-solid fa-right-to-bracket text-cyan-950 mr-5"></i><Link to='/logout'>Logout</Link></li>
            </ul>
    </div>
  );
}
